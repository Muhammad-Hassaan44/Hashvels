...
import { Building2, Phone, Mail, AlertCircle } from "lucide-vue-next";
        ...
        <div class="flex flex-col gap-6">
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <div class="text-muted-foreground">tech.hashvels@gmail.com</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="grid gap-6">
            <form @submit.prevent="handleSubmit" class="grid gap-6">
              ...
              <Alert
                v-if="successMessage"
                variant="default"
                class="bg-green-100/50 dark:bg-green-900/50 border-green-500/50"
              >
                <AlertCircle class="w-4 h-4 text-green-500" />
